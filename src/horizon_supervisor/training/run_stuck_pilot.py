...
def _harbor_command(
    *,
    ...
    stop_after_healthy_window: bool = False,
    ...
    command = [
        ...
        "--agent-kwarg",
        f"pilot_stop_after_healthy_window={json.dumps(stop_after_healthy_window)}",
        "--agent-kwarg",
...
def _run_trial(
    *,
    ...
    command = _harbor_command(
        ...
        stop_after_healthy_window=stop_after_healthy_window,
